 ...
 * <!-- end-user-doc -->
 * @see org.soluvas.category.CategoryPackage#getCategoryStatus()
 * @model
 * @generated
 */
public enum CategoryStatus implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final CategoryStatus[] VALUES_ARRAY =
		new CategoryStatus[] {
			DRAFT,
			ACTIVE,
			INACTIVE,
	 ...
	 * @generated
	 */
	public static CategoryStatus get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			CategoryStatus result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static CategoryStatus get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private CategoryStatus(int value, String name, String literal) {
		this.value = value;
		this.name = name;
