 ...
 * @author ceefour
 */
@Command(scope="assoc", name="left", description="List LeftSet from assoc repository.")
public class AssocLeftCommand extends OsgiCommandSupport {

	private static final Logger log = LoggerFactory.getLogger(AssocLeftCommand.class);
	...
	public AssocLeftCommand(ServiceLookup svcLookup) {
		super();
