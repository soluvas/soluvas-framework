...
public class StringValueImpl extends ValueImpl<String> implements StringValue {
	...
	protected EClass eStaticClass() {
		return DataPackage.Literals.STRING_VALUE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.STRING_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.STRING_VALUE__VALUE:
				return getValue();
		}
