 ...
 * @author rudi
 */
public class PersistentUUIDSet implements UserType {
	...
	public Object nullSafeGet(ResultSet rs, String[] names,
		...
		final Set<UUID> sets = new TreeSet<UUID>();
		final Object array = theArray.getArray();
		for (final UUID identifier : (UUID[]) array) {
			sets.add(identifier);
		}
		return sets;
    }
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index,
	    ...
	    if (value == null) {
	    	...
	    	final Set<UUID> castObject = (Set<UUID>) value;
	    	final Array array = session.connection().createArrayOf(
	    			"uuid", castObject.toArray(new UUID[] {}));
	...
	public Object deepCopy(Object value) throws HibernateException {
		if (value != null)
			return new TreeSet<>((Collection<UUID>) value);
		else 
			return null;
	}
