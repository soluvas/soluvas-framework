 ...
 * @author atang
 */
public class PersistentUUIDList implements UserType {
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index,
	    ...
	    if (value == null) {
	    	...
	    	List<UUID> castObject = (List<UUID>) value;
	        Array array = session.connection().createArrayOf("uuid", castObject.toArray(new UUID[] {}));
	...
	public Object deepCopy(Object value) throws HibernateException {
		if (value != null)
			return new ArrayList<>((List<UUID>) value);
		else 
			return new ArrayList<>(ImmutableList.<UUID>of());
	}
