...
/**
 * This is the item provider adapter for a {@link org.soluvas.commons.ThingInfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThingInfoItemProvider
	 ...
	 * @generated
	 */
	public ThingInfoItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addImageIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ThingInfo_imageId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ThingInfo_imageId_feature", "_UI_ThingInfo_type"),
				 CommonsPackage.Literals.THING_INFO__IMAGE_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ThingInfo"));
	}
	...
	public String getText(Object object) {
		String label = ((ThingInfo)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ThingInfo_type") :
			getString("_UI_ThingInfo_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ThingInfo.class)) {
