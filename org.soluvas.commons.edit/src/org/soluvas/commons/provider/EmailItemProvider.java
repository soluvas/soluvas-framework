...
/**
 * This is the item provider adapter for a {@link org.soluvas.commons.Email} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CommonsPackage.Literals.EMAIL__EMAIL,
				 true,
				 false,
				 false,
	...
	protected void addPrimaryPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Email_primary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Email_primary_feature", "_UI_Email_type"),
				 CommonsPackage.Literals.EMAIL__PRIMARY,
				 true,
				 false,
				 false,
	...
	protected void addValidationTimePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Email_validationTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Email_validationTime_feature", "_UI_Email_type"),
				 CommonsPackage.Literals.EMAIL__VALIDATION_TIME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
