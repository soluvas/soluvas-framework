...
/**
 * This is the item provider adapter for a {@link org.soluvas.commons.FacebookAccessible} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FacebookAccessibleItemProvider
	 ...
	 * @generated
	 */
	public FacebookAccessibleItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns FacebookAccessible.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FacebookAccessible"));
	}
	...
	public String getText(Object object) {
		String label = ((FacebookAccessible)object).getFacebookAccessToken();
		return label == null || label.length() == 0 ?
			getString("_UI_FacebookAccessible_type") :
			getString("_UI_FacebookAccessible_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FacebookAccessible.class)) {
