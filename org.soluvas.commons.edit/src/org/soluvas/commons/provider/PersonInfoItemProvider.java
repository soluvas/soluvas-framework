...
/**
 * This is the item provider adapter for a {@link org.soluvas.commons.PersonInfo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonInfoItemProvider
	 ...
	 * @generated
	 */
	public PersonInfoItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addGenderPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersonInfo_gender_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersonInfo_gender_feature", "_UI_PersonInfo_type"),
				 CommonsPackage.Literals.PERSON_INFO__GENDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEmailPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PersonInfo_email_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PersonInfo_email_feature", "_UI_PersonInfo_type"),
				 CommonsPackage.Literals.PERSON_INFO__EMAIL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PersonInfo"));
	}
	...
	public String getText(Object object) {
		String label = ((PersonInfo)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PersonInfo_type") :
			getString("_UI_PersonInfo_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PersonInfo.class)) {
