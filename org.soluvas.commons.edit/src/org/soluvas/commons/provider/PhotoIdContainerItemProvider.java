...
/**
 * This is the item provider adapter for a {@link org.soluvas.commons.PhotoIdContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PhotoIdContainerItemProvider
	 ...
	 * @generated
	 */
	public PhotoIdContainerItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((PhotoIdContainer)object).getPhotoId();
		return label == null || label.length() == 0 ?
			getString("_UI_PhotoIdContainer_type") :
			getString("_UI_PhotoIdContainer_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PhotoIdContainer.class)) {
