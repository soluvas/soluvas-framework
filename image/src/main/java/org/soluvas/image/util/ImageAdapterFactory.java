...
public class ImageAdapterFactory extends AdapterFactoryImpl {
	...
	protected ImageSwitch<Adapter> modelSwitch =
		new ImageSwitch<Adapter>() {
			...
			@Override
			public Adapter caseImageMagickTransformer(ImageMagickTransformer object) {
				return createImageMagickTransformerAdapter();
			}
			@Override
			public Adapter caseFolderConnector(FolderConnector object) {
			...
			@Override
			public Adapter caseWatermarkLike(WatermarkLike object) {
			...
			@Override
			public Adapter caseOverlayLike(OverlayLike object) {
				return createOverlayLikeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.soluvas.image.ImageMagickTransformer <em>Magick Transformer</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createImageMagickTransformerAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.soluvas.image.FolderConnector <em>Folder Connector</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.soluvas.image.WatermarkLike <em>Watermark Like</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createWatermarkLikeAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.soluvas.image.OverlayLike <em>Overlay Like</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOverlayLikeAdapter() {
		return null;
	}
