...
public class TenantAddCommand extends ExtCommandSupport {
	...
	@Option(name="--mongopass", description="MongoDB password (default: autogenerated).")
	...
	protected AppManifest doExecute() throws Exception {
		...
		provisionData.setMongoPassword(mongoPassword != null ? mongoPassword : UUID.randomUUID().toString().substring(0, 8));
		...
		System.out.println(ansi().render("MongoDB password: @|bold %s|@", provisionData.getMongoPassword()));
