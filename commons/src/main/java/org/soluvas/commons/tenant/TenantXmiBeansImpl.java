...
//			path = pathTemplate.expand(scope).replace("file://", "");ini tuk windows malah duplicate "home dir"-nya
		} catch (Exception e) {
...
//			return new File(path);ini tuk windows malah duplicate "home dir"-nya
		} catch (Exception e) {
			throw new TenantException(e, "Invalid %s file URI '%s' for tenant '%s' template: %s scope: %s",
//			throw new TenantException(e, "Invalid %s file path '%s' for tenant '%s' template: %s scope: %s",ini tuk windows malah duplicate "home dir"-nya
