...
public class TranslationImpl extends MinimalEObjectImpl.Container implements Translation {
	...
	/**
	 * The cached value of the '{@link #getMessages() <em>Messages</em>}' map.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getMessages()
	 * @generated
	 * @ordered
	 */
	protected EMap<String, String> messages;
	...
	protected EClass eStaticClass() {
		return CommonsPackage.Literals.TRANSLATION;
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonsPackage.TRANSLATION__LANGUAGE, oldLanguage, language));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CommonsPackage.TRANSLATION__MESSAGES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CommonsPackage.TRANSLATION__LANGUAGE:
				return getLanguage();
			case CommonsPackage.TRANSLATION__MESSAGES:
				if (coreType) return getMessages();
				else return getMessages().map();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case CommonsPackage.TRANSLATION__LANGUAGE:
				...
				return;
			case CommonsPackage.TRANSLATION__MESSAGES:
				((EStructuralFeature.Setting)getMessages()).set(newValue);
				return;
		}
