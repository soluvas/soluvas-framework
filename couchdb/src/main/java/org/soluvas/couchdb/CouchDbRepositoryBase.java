...
//			return ImmutableList.copyOf(entities);
	...
	public <S extends T> Collection<S> modify(Map<String, S> entities) {
		...
		// Cloudant as of 19 Sep 2014 throws DbAccessException: 417 Expectation failed
