...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>App Session Attribute Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class AppSessionAttributeEntryImpl extends EObjectImpl implements BasicEMap.Entry<String,Object> {
	 ...
	 * @generated
	 */
	public AppSessionAttributeEntryImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SecurityPackage.Literals.APP_SESSION_ATTRIBUTE_ENTRY;
	}
	...
	public void setTypedValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SecurityPackage.APP_SESSION_ATTRIBUTE_ENTRY__VALUE, oldValue, value));
	}
