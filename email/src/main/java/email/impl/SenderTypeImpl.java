 ...
 * <ul>
 *   <li>{@link email.impl.SenderTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link email.impl.SenderTypeImpl#getBundle <em>Bundle</em>}</li>
 *   <li>{@link email.impl.SenderTypeImpl#getNsPrefix <em>Ns Prefix</em>}</li>
 *   <li>{@link email.impl.SenderTypeImpl#getFrom <em>From</em>}</li>
 *   <li>{@link email.impl.SenderTypeImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link email.impl.SenderTypeImpl#getReplyTo <em>Reply To</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
