...
import org.soluvas.email.builtin.impl.BuiltinPackageImpl;
...
public class EmailPackageImpl extends EPackageImpl implements EmailPackage {
	 ...
	 * @see email.EmailPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static EmailPackage init() {
		...
		BuiltinPackageImpl theBuiltinPackage = (BuiltinPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(BuiltinPackage.eNS_URI) instanceof BuiltinPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(BuiltinPackage.eNS_URI) : BuiltinPackage.eINSTANCE);
