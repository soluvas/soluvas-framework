 ...
 * <ul>
 *   <li>{@link email.impl.LayoutImpl#getPageSubject <em>Page Subject</em>}</li>
 *   <li>{@link email.impl.LayoutImpl#getPagePlain <em>Page Plain</em>}</li>
 *   <li>{@link email.impl.LayoutImpl#getPageHtml <em>Page Html</em>}</li>
 *   <li>{@link email.impl.LayoutImpl#getLayoutType <em>Layout Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
