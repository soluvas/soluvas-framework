 ...
 * <ul>
 *   <li>{@link email.impl.TemplateTypeImpl#getResourceType <em>Resource Type</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getResourceUri <em>Resource Uri</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getResourceName <em>Resource Name</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getBundle <em>Bundle</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getSubjectTemplate <em>Subject Template</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getPlainTemplate <em>Plain Template</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getHtmlTemplate <em>Html Template</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getNsPrefix <em>Ns Prefix</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getJavaClassName <em>Java Class Name</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getJavaClass <em>Java Class</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getJavaClassStatus <em>Java Class Status</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getEFactory <em>EFactory</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getEClass <em>EClass</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getEClassStatus <em>EClass Status</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getEPackageNsPrefix <em>EPackage Ns Prefix</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getEClassName <em>EClass Name</em>}</li>
 *   <li>{@link email.impl.TemplateTypeImpl#getEPackageName <em>EPackage Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
