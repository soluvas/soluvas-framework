...
import email.EmailCatalog;
import email.EmailPackage;
import email.LayoutType;
 ...
 * <ul>
 *   <li>{@link email.impl.EmailCatalogImpl#getNsPrefix <em>Ns Prefix</em>}</li>
 *   <li>{@link email.impl.EmailCatalogImpl#getPageTypes <em>Page Types</em>}</li>
 *   <li>{@link email.impl.EmailCatalogImpl#getLayoutTypes <em>Layout Types</em>}</li>
 *   <li>{@link email.impl.EmailCatalogImpl#getSenderTypes <em>Sender Types</em>}</li>
 *   <li>{@link email.impl.EmailCatalogImpl#getGeneratedPackageName <em>Generated Package Name</em>}</li>
 *   <li>{@link email.impl.EmailCatalogImpl#getEcoreUrl <em>Ecore Url</em>}</li>
 *   <li>{@link email.impl.EmailCatalogImpl#getEPackage <em>EPackage</em>}</li>
 *   <li>{@link email.impl.EmailCatalogImpl#getEFactory <em>EFactory</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
