...
import email.EmailFormat;
import email.EmailPackage;
import email.Recipient;
import email.WebSecurity;
 ...
 * <ul>
 *   <li>{@link email.impl.RecipientImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link email.impl.RecipientImpl#getName <em>Name</em>}</li>
 *   <li>{@link email.impl.RecipientImpl#getFirstName <em>First Name</em>}</li>
 *   <li>{@link email.impl.RecipientImpl#getLastName <em>Last Name</em>}</li>
 *   <li>{@link email.impl.RecipientImpl#getRoleName <em>Role Name</em>}</li>
 *   <li>{@link email.impl.RecipientImpl#getPreferredFormat <em>Preferred Format</em>}</li>
 *   <li>{@link email.impl.RecipientImpl#getPreferredWebSecurity <em>Preferred Web Security</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
