 ...
 * <ul>
 *   <li>{@link email.PageType#getSenderTypeName <em>Sender Type Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see email.EmailPackage#getPageType()
 * @model
 * @generated
 */
public interface PageType extends TemplateType<Page> {
	 ...
	 * @see email.EmailPackage#getPageType_SenderTypeName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link email.PageType#getSenderTypeName <em>Sender Type Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
