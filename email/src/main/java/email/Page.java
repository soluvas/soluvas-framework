 ...
 * <ul>
 *   <li>{@link email.Page#getLayout <em>Layout</em>}</li>
 *   <li>{@link email.Page#getPageType <em>Page Type</em>}</li>
 *   <li>{@link email.Page#getSender <em>Sender</em>}</li>
 *   <li>{@link email.Page#getMailSession <em>Mail Session</em>}</li>
 * </ul>
 * </p>
 *
 * @see email.EmailPackage#getPage()
 * @model abstract="true"
 * @generated
 */
public interface Page extends Template {
	 ...
	 * @see email.EmailPackage#getPage_Layout()
	 * @model
	 * @generated
	 */
	Layout getLayout();
	...
	/**
	 * Sets the value of the '{@link email.Page#getLayout <em>Layout</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see email.EmailPackage#getPage_PageType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link email.Page#getPageType <em>Page Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see email.EmailPackage#getPage_Sender()
	 * @model required="true"
	 * @generated
	 */
	Sender getSender();
	...
	/**
	 * Sets the value of the '{@link email.Page#getSender <em>Sender</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see email.EmailPackage#getPage_MailSession()
	 * @model dataType="email.MailSession" required="true" transient="true"
	 * @generated
	 */
	Session getMailSession();

	/**
	 * Sets the value of the '{@link email.Page#getMailSession <em>Mail Session</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * <!-- end-model-doc -->
	 * @model dataType="org.soluvas.commons.List<email.Email>" required="true" many="false"
	 * @generated
	 */
